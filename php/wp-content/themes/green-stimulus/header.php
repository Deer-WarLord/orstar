...
<div id="wrapper">
	...
	<div id="social" class="group">
		...
		<?php if ( $options['twitter'] )
			...
			<p class="tweet-meta">Обновлено <a href="http://twitter.com/<?php echo $options['twitter']; ?>" target = "_blank">@<?php echo $options['twitter']; ?></a></p>
			
			<?php } else { ?>
				
				<p class="tweet-meta">Вы можете отображать свои последние сообщения в Twitter, введя свое имя пользователя в настройках темы.</p>
