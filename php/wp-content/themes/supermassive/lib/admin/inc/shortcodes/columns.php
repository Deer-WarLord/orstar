...
function gp_columns($atts, $content = null, $code) {
	...
	if($clear === false) {
		return '<div class="columns '.$class.' '.$col_type.' '.$name.' '.$text_align.'" style="'.$margins.'"><div style="'.$height.$padding.$background.'">'.do_shortcode($content).'<div class="clear"></div></div></div>';
	} else {
		return '<div class="columns '.$class.' '.$col_type.' '.$name.' '.$text_align.'" style="'.$margins.'"><div style="'.$height.$padding.$background.'">'.do_shortcode($content).'<div class="clear"></div></div></div><div class="clear"></div>';
	}
}
