...
function insertgpLink() {
	...
	var style = document.getElementById('style_panel');
		...
		if (styleid != 0 && styleid == 'button') {
			tagtext = '['+ styleid + ' link="" color="darkgret" target=""]Read More[/' + styleid + ']';	
		}
		...
		if (styleid != 0 && styleid == 'image') {
			tagtext = '['+ styleid + ' url="" width="" height="" link="" target="" border="false" align="alignleft" margins="" alt="" title="" lightbox="none" preload="false" shadow="none" reflection="none"]';	
		}
		...
		if (styleid != 0 && styleid == 'notification') {
			tagtext = '['+ styleid + ' type="star"]Insert your text here[/' + styleid + ']';	
		}
	
		// Posts
		if (styleid != 0 && styleid == 'blog') {
			tagtext = '['+ styleid + ' cats="" images="true" image_width="640" image_height="250" image_wrap="false" cols="1" per_page="5" link="both" orderby="date" order="desc" offset="0" content_display="excerpt" excerpt_length="400" title="true" title_size="" title_font="" meta="true" read_more="true" pagination="true" preload="false"]';	
		}
		...
		if (styleid != 0 && styleid == 'related_posts') {
			tagtext = '['+ styleid + ' id="" cats="" images="true" image_width="55" image_height="55" image_wrap="false" cols="3" per_page="6" link="both" orderby="random" order="desc" offset="0" content_display="excerpt" excerpt_length="0" title="true" title_size="" title_font="" meta="false" read_more="false" pagination="false" preload="false"]';	
		}
		...
		if (styleid != 0 && styleid == 'slider') {
			tagtext = '['+ styleid + ' name="slider" width="980" height="400" cats="" slides="-1" timeout="6" orderby="menu_order" order="asc" arrows="true" buttons="true" shadow="none" margins="" align="alignnone" preload="false"]';	
		}
