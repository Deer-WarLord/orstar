...
function if_admin_link() {
	...
	$wp_admin_bar->add_menu( array( 'id' => 'iFeature', 'title' => 'Настройки iFeature', 'href' => admin_url('themes.php?page=ifeature')  ) ); 
}
...
function if_register_menus() {
	register_nav_menus(
	array( 'header-menu' => __( 'Верхнее меню' ), 'footer-menu' => __( 'Нижнее меню' ))
  );
}
...
function if_widgets_init() {
    register_sidebar(array(
    	'name' => 'Виджеты в сайдбаре',
    	'id'   => 'sidebar-widgets',
    	'description'   => 'Виджеты будут помещены в боковую колонку.',
    	...
    	register_sidebar(array(
		'name' => 'Виджеты в подвале',
		'id' => 'footer-widgets',
		'description' => 'Виджеты будут помещены в нижнюю часть сайта',
