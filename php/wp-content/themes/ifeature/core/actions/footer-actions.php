...
function synapse_footer_widgets() { 
   	...
   	if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Footer") ) { ?>
		...
		<div class="three columns footer-widgets">
			<h3 class="footer-widget-title"><?php printf( __( 'Управление', 'core' )); ?></h3>
			<ul>
    		<?php wp_register(); ?>
    		<li><?php wp_loginout(); ?></li>
    		<?php if ( (is_home())&&!(is_paged()) ){ ?><li><a href="http://designlove.ru/" title="Русские темы WordPress">Темы WordPress</a></li><?php } ?>
    		<?php wp_meta(); ?>
    		</ul>
		</div>
