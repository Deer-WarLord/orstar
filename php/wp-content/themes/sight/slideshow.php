    ...
    if ( !empty($slides) ) : $exl_posts = Array(); ?>
        ...
        <div class="slide clear">
            <div class="post">
                ...
                <div class="post-meta">Автор: <span class="post-author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="Публикации автора: <?php the_author(); ?>"><?php the_author(); ?></a></span>, <span
                        class="post-date"><?php the_time(__('d M Y')) ?></span> &bull; <?php comments_popup_link(__('Отзывов нет'), __('1 отзыв'), __('Отзывов (%)'), '', __('Обсуждение закрыто') ); ?> <?php edit_post_link( __( 'Править'), '&bull; '); ?></div>
